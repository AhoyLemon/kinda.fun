<script setup>
  ...
  // SEO and meta tags
  useHead({
    title: 'Kinda Fun - Games by Lemon',
    meta: [
      { name: 'description', content: 'A collection of kinda fun games and tools by Lemon' },
      { property: 'og:title', content: 'Kinda Fun' },
      { property: 'og:description', content: 'A collection of kinda fun games and tools by Lemon' },
    ]
  })
  ...
  const thingData = {
    ...
    invalid: {
      ...
      `,
      url: computed(() => `${baseURL.value}/invalid`),
      buttonText: "",
      isMultiplayer: true,
    ...
    cameo: {
      ...
      url: computed(() => `${baseURL.value}/cameo`),
    ...
    meeting: {
      ...
      url: computed(() => `${baseURL.value}/meeting`),
    ...
    wrongest: {
      ...
      url: computed(() => `${baseURL.value}/wrongest`),
      isMultiplayer: true,
    ...
    sisyphus: {
      ...
      url: computed(() => `${baseURL.value}/sisyphus`),
      buttonText: "Suffer.",
    ...
    pretend: {
      ...
      url: computed(() => `${baseURL.value}/pretend`),
  ...
  const setGameData = (thingData) => {
    ...
    currentThing.url = typeof thingData.url === 'string' ? thingData.url : thingData.url.value ?? "";
...
@import '../src/views/home/scss/_variables.scss';
@import '../src/views/home/scss/_default.scss';
@import '../src/views/home/scss/_transitions.scss';
@import '../src/views/home/scss/_title-screen.scss';
@import '../src/views/home/scss/_testing.scss';
</style>
