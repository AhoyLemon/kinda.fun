...
useHead({
  ...
  meta: [
    ...
    { name: 'keywords', content: 'browser games, free games, indie games, Lemon, kinda fun, web games, party games, comedy games' },
    ...
    { property: 'og:image', content: '/img/og-wide.png' },
  ...
  link: [
    { rel: 'canonical', href: 'https://kinda.fun' },
...
const computedWidth = computed(() => {
  return import.meta.client ? window.innerHeight : 0;
});
