...
// RANDOM
{
  ...
  cards: ["Froot Loops are spelled that way because the cereal contains {blood.}", "Spaghetti and Meatballs is known as {Pasketti and Meatbulbs} in Italy.", "{A barn owl} is the only animal on earth that can feel love.", "No one understands how {drums} work."]
}];
"use strict";
...
var app = new Vue({
  ...
  mounted: function () {
    ...
    self.players = [{
      "name": "Four",
      "socketID": "amu153xNcGNFYbrNAAAZ",
      "card": "Clowns are {sexy.}",
      "score": 2
    }, {
      "name": "One",
      "socketID": "H3VJpdzS0oFvU2KnAAAT",
      "card": "Laura Ingalls Wilder is {God.}",
      "score": 4
    }, {
      "name": "Two",
      "socketID": "Q0Jb1qZaIjel8a3iAAAV",
      "card": "Ice is the {natural enemy of} bottled water.",
      "score": -4
    }, {
      "name": "Three",
      "socketID": "d-BI3QtAXf0XxMTuAAAX",
      "card": "Women were {made to be} spanked by men.",
      "score": -2
    }];
    self.statementHistory = [{
      "card": "{Man used to live} for hundreds of years disease free.",
      "playerIndex": 0,
      "playerName": "One",
      "score": 0
    }, {
      "card": "Jelqing (manually wringing blood into your penis) {is positively REQUIRED just prior to sex.}",
      "playerIndex": 1,
      "playerName": "Two",
      "score": 0
    }, {
      "card": "The first polio vaccine, the Salk vaccine{, was a total disaster}.",
      "playerIndex": 2,
      "playerName": "Three",
      "score": -3
    }, {
      "card": "{It is legal to} post nude photos of someone without their consent.",
      "playerIndex": 3,
      "playerName": "Four",
      "score": 3
    }, {
      "card": "It's almost impossible to quit {giving yourself wedgies.}",
      "playerIndex": 0,
      "playerName": "Two",
      "score": -1
    }, {
      "card": "The inner penis {is before} the outer penis of course.",
      "playerIndex": 1,
      "playerName": "Three",
      "score": -1
    }, {
      "card": "There is no difference between night dreams and daytime dreams {except about elephant.}",
      "playerIndex": 2,
      "playerName": "Four",
      "score": 1
    }, {
      "card": "{Leonardo DiCaprio's salary} is bankrupting America.",
      "playerIndex": 3,
      "playerName": "One",
      "score": 1
    }, {
      "card": "The Latino people have never had {a revolution.}",
      "playerIndex": 0,
      "playerName": "Three",
      "score": 3
    }, {
      "card": "I was having sex with my ladyfriend {and we're both prego.}",
      "playerIndex": 1,
      "playerName": "Four",
      "score": -3
    }, {
      "card": "We don't know how to make fat people {into thin people or how to make thin people into fat people.}",
      "playerIndex": 2,
      "playerName": "One",
      "score": 0
    }, {
      "card": "No one on Earth is {gay.}",
      "playerIndex": 3,
      "playerName": "Two",
      "score": 0
    }];
