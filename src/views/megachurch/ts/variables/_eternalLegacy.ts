...
export interface EternalLegacyDarkDeed {
  ...
  effect: string;
  dayPurchased?: number; // Day the deed was purchased
  dailyHeat?: number; // Heat added each day while deed is active
  dailyMoney?: number; // Income added each day while deed is active
  purchases?: ArtifactPurchase[]; // Purchase history for repeatable deeds
}
