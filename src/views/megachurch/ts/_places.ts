...
export const places: Place[] = [
  ...
  },
  {
    ...
    religions: [
      ...
      { id: 21, name: "Prosperity Gospel", weight: 18 },
      { id: 20, name: "Theistic Satanism", weight: 30 },
  ...
  },
  {
    ...
    religions: [
      ...
      { id: 23, name: "The Digital Ascension", weight: 40 },
      { id: 13, name: "New-Age Spirituality", weight: 35 },
      { id: 12, name: "The Gaia Collective", weight: 30 },
      { id: 19, name: "Secular Humanists", weight: 40 },
      { id: 21, name: "Prosperity Gospel", weight: 45 },
  ...
  },
  {
    ...
    religions: [
      ...
      { id: 11, name: "The Church of Eros", weight: 20 },
      { id: 18, name: "The Order of the Alpha Male", weight: 20 },
      { id: 19, name: "The Queens' Dominion", weight: 20 },
  ...
  },
  {
    ...
    avgNetWorth: 60000,
    religions: [
      { id: 2, name: "Catholic", weight: 22 },
      { id: 19, name: "Secular Humanists", weight: 20 },
      { id: 27, name: "Agnostic Atheists", weight: 18 },
      ...
      { id: 19, name: "The Queens' Dominion", weight: 6 },
    ],
  },
  {
    id: 9,
