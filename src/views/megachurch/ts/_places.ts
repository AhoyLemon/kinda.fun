...
export const places: Place[] = [
  {
    ...
    religions: [
      ...
      { id: 21, name: "Prosperity Gospel", weight: 5 },
      { id: 28, name: "Seventh-day Adventism", weight: 5 },
      { id: 12, name: "The Gaia Collective", weight: 4 },
      { id: 11, name: "The Church of Eros", weight: 4 },
      { id: 24, name: "The Church of Satan", weight: 4 },
      { id: 14, name: "The Starseed Pilgrims", weight: 4 },
      { id: 23, name: "The Digital Ascension", weight: 3 },
      { id: 22, name: "The Order of the Divine Algorithm", weight: 3 },
      { id: 30, name: "Confucianism", weight: 3 },
      { id: 20, name: "Theistic Satanism", weight: 3 },
      { id: 18, name: "The Order of the Alpha Male", weight: 3 },
      { id: 15, name: "2 Fast 2 Faithful", weight: 2 },
      { id: 25, name: "Temple of the Eternal Sun", weight: 2 },
      { id: 5, name: "Zardoz", weight: 2 },
      { id: 17, name: "The Church of the High Priest", weight: 2 },
      { id: 16, name: "The Sovereign Guild of Untethered Minds", weight: 2 },
      { id: 4, name: "The Queens' Dominion", weight: 2 },
    ],
  },
  {
    id: 1,
    ...
    religions: [
      ...
      { id: 17, name: "The Church of the High Priest", weight: 11 },
  ...
  },
  {
    ...
    avgNetWorth: 80000,
    religions: [
      { id: 17, name: "The Church of the High Priest", weight: 49 },
