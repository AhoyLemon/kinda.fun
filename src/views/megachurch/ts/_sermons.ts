// Allowed values
import { Categories, Tags, Religions } from "./_types";
import { populations } from "./_religions";

export interface Sermon {
  id: number; // UID for sermon
  title: string; // The message of the sermon
  desc?: string; // Optional description of the sermon
  tags?: Tags[]; // What is this sermon about
  religions?: Religions[]; // Who does this sermon appeal to?
  dislikedBy?: {
    tags?: Tags[]; // People with this tag will not like this sermon.
    religions?: Religions[]; // People from these religions will not like this sermon.
  };
}
