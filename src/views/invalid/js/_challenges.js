export const challenges = [
...

  {
    ...
    name: "Bob's Burgers",
    nameAsRule:
      "Your password must be the first name of a Bob's Burgers character",
...

  {
    ...
    nameAsRule:
      "Your password must be a word the Oxford English Dictionary recognizes as a synonym for “breasts”",
...

  {
    ...
    nameAsRule:
      "Your password must be the title of a film written and/or directed by Joel and/or Ethan Coen.",
...

  {
    ...
    name: "Worst Actors",
    nameAsRule:
      "Your password must be the LAST name of a “Worst Actor” Razzie award winner",
...

  {
    ...
    nameAsRule:
      "Your password must be the LAST name of a “Worst Actress” Razzie award winner",
...

  {
    ...
    name: "Olympic Sports",
    nameAsRule:
      "Your password must be an event currently played during the Olympics.",
    failedMessage:
      "[PASS] is not a Summer or Winter event listed on the Olympics website.",
    possible: [
      "ARCHERY",
      "BADMINTON",
      "BASEBALL",
...

  {
    ...
    failedMessage:
      "Did you find [PASS] on AllRecipes? Please try another cocktail.",
    possible: [
      "OLD FASHIONED",
      "MARGARITA",
      "COSMOPOLITAN",
...

  {
    ...
    nameAsRule:
      "Your password must be the first name of a recurring Simpsons character who DOESN'T have the last name of Simpson",
    hint: "Fat Tony's first name isn't Tony.",
    failedMessage:
      "[PASS] is not a Simpsons character. Or is. It's 32+ seasons.",
    possible: [
      "ABE",
      "AGNES",
      "AKIRA",
  ...
  */
...

  {
    ...
    nameAsRule:
      "Your password must be the name of a one-hit wonder artist from the 1980s.",
...

  {
    ...
    nameAsRule:
      "Your password must be the name of a one-hit wonder artist from the 1990s.",
    failedMessage:
      "[PASS] is not considered a 1990s one-hit wonder, according to Wikipedia.",
    possible: [
      "JANE CHILD",
      "SINEAD O'CONNOR",
      "MELLOW MAN ACE",
    ...
    source:
      "https://en.wikipedia.org/wiki/List_of_one-hit_wonders_in_the_United_States#1990s",
  },

  {
    ...
    nameAsRule:
      "Your password must be the name of a one-hit wonder band from the 2000s.",
    failedMessage:
      "[PASS] is not considered a 2000s one-hit wonder, according to Wikipedia.",
    possible: [
      "HOKU",
      "NINE DAYS",
      "SAMANTHA MUMBA",
    ...
    source:
      "https://en.wikipedia.org/wiki/List_of_one-hit_wonders_in_the_United_States#2000s",
  },

  {
    ...
    nameAsRule:
      "Your password must be the name of a Western art period or movement.",
    failedMessage:
      "[PASS] is not a Western art period, according to Wikipedia.",
    possible: [
      "EARLY CHRISTIAN",
      "MIGRATION",
      // ALSO
...

  {
    ...
    nameAsRule:
      "Your password must be the name of a Modern or Post-Modern Western architectural style or school.",
    failedMessage:
      "[PASS] is not a style or school used in Western architecture.",
    possible: [
      "AVANT-GARDE",
      "PARAMETRICISM",
      "CHICAGO SCHOOL",
...

  {
    ...
    failedMessage:
      "[PASS] isn't a precious gemstone, according to The Antique Jewelry Company",
    possible: [
      "AGATE",
      "AMAZONITE",
      "AMBER",
...

  {
    ...
    failedMessage:
      "[PASS] isn't an officially recognized by the International Astronomical Union.",
    possible: [
      "ANDROMEDA",
      "ANTLIA",
      "APUS",
...

  {
    ...
    name: "Disney Movies",
    nameAsRule:
      "Your password must be a Disney or Pixar animated film (excluding sequels).",
    failedMessage:
      "[PASS] isn't an animated film by Disney or Pixar, please try again.",
    possible: [
...

  {
    ...
    failedMessage:
      "[PASS]? Must be a specialty where you're from. Try something a little less fancy.",
    possible: [
      "AMERICAN",
      "ASIAGO",
      "BLUE CHEESE",
...

  {
    ...
    nameAsRule:
      "Your password must be the full name of a Looney Tunes character.",
    hint: "First and last names required in some (but not all) cases.",
    failedMessage:
      "[PASS] must have gotten lost on their way to Albuquerque. Try again.",
    possible: [
      "BABBI AND CATSTELLO",
      "BARNYARD DAWG",
      "BEANS",
...

  {
    ...
    failedMessage:
      "[PASS] is a hard no. Guess again - pitter-patter, let's get at 'er.",
    possible: [
      "WAYNE",
      "DARYL",
      "KATY",
...

  {
    ...
    nameAsRule:
      "Your password must be an animal (vertebrate or invertebrate) that is a scavenger.",
  ...
  },
  {
    ...
    name: "Smash Bros.",
    nameAsRule:
      "Your password must be a playable character in Super Smash Bros. Ultimate",
    hint: "Not including DLC",
    failedMessage:
      "[PASS] isn't a playable character in Super Smash Bros. Ultimate",
    possible: [
      "BAYONETTA",
      "BOWSER",
      "BOWSER JR.",
...

  {
    ...
    nameAsRule:
      "Your password must be a form of currency traded on the foreign exhange market",
...

  {
    ...
    source:
      "https://www.adducation.info/general-knowledge-politics-religion/greek-gods-and-goddesses/",
  },
...

  {
    ...
    name: "J.R.R. Tolkien",
    nameAsRule:
      "Your password must be the first name of a notable character from J.R.R. Tolkien's Middle-Earth books.",
    failedMessage: "[PASS] isn't on the list, please try again.",
    possible: [
      "ARAGORN",
      "ARWEN",
...

  {
    ...
    nameAsRule:
      "Your password must be a Medieval weapon used by a single combatant.",
    failedMessage: "[PASS] isn't on the list, please try again.",
    possible: [
      "BATTLE AXE",
      "BEC DE CORBIN",
...

  {
    ...
    nameAsRule:
      "Your password must one of Sports Illustrated's 100 Best Wrestlers of All Time",
    ...
    source:
      "https://www.si.com/extra-mustard/2016/07/26/wwe-wcw-ecw-100-best-wrestlers-all-time",
  },

  {
    ...
    nameAsRule:
      "Your password must be one of Power Thesaurus' synonym for “penis”",
    failedMessage: "[PASS] is not on the list, please try again.",
    naughty: true,
    possible: [
      "DICK",
...

  {
    ...
    nameAsRule:
      "Your password must be one of Power Thesaurus' synomyms for “vulva”",
    failedMessage: "[PASS] is not on the list, please try again.",
    naughty: true,
    possible: [
      "PUSSY",
...

  {
    ...
    nameAsRule:
      "Your password must be a Hanna-Barbera cartoon series, not including spin-offs and pilots.",
    failedMessage: "[PASS] is not on the list, please try again.",
    possible: [
      "2 STUPID DOGS",
...

  {
    ...
    nameAsRule:
      "Your password must be an instrument commonly used in an orchestra.",
    failedMessage: "[PASS] is not on the list, please try again.",
    possible: [
      "VIOLIN",
      "VIOLA",
...

  {
    ...
    nameAsRule:
      "Your password must be the name of a pigment used in artist paints.",
    failedMessage: "[PASS] is not on the list, please try again.",
    possible: [
      "CADMIUM LEMON",
      "CADMIUM YELLOW",
...

  {
    ...
    nameAsRule:
      "Your password must be an animal or mythical creature found on a coat of arms",
    failedMessage: "[PASS] is not on the list, please try again.",
    possible: [
      "ALLOCAMELUS",
      "AMPHIPTERE",
...

  {
    ...
    name: "Fruits",
    nameAsRule:
      "Your password must be a popular fruit; the name does not need a specific variety name.",
    failedMessage: "[PASS] is not on the list, please try again.",
    possible: [
      "TOMATO",
      "BANANA",
...

  {
    ...
    source:
      "https://www.umami-insider.com/common-japanese-sushi-ingredients-guide/",
  },

  {
    ...
    nameAsRule:
      "Your password must be a Great House from Game of Thrones / A Song of Ice & Fire",
...

  {
    ...
    name: "Pizza Toppings",
    nameAsRule:
      "Your password must be a pizza topping available at a large chain.",
